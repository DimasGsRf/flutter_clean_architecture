...
abstract class Controller
  ...
  /// _refreshes the [ControlledWidgets] and the [StatefulWidgets] that depends on [FlutterCleanArchitecture.getController] of the [cleanArch.View] associated with the [Controller] if it is still mounted.
  @protected
  void refreshUI() {
    if (_isMounted) {
      notifyListeners();
  ...
  /// Retrieves the [State<StatefulWidget>] associated with the [cleanArch.View]
  @protected
  ...
  /// Retrieves the [GlobalKey<State<StatefulWidget>>] associated with the [cleanArch.View]
  @protected
  ...
  /// Called before [cleanArch.View.didChangeDependencies] is called
  ///
  /// Should be used when need to perform some action on [cleanArch.View.didChangeDependencies] life cycle.
  /// [cleanArch.View.initViewState] should be called before the actions you need to perform. Like [didChangeDependencies], you can safely perform
  ...
  /// Called before [cleanArch.View.initState] is called
  ///
  /// Should be used when need to perform some action on [cleanArch.View.initState] life cycle.
  ///
  /// ```dart
  ///     class MyController extends Controller {
  ///       @override
